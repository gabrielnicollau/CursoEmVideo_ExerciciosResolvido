...
while mais != 0:  # Enquanto mais não receber o input com valor 0, vai ficar em loop perguntado qual o valor.
    ...
    while total >= cont:  # Cont sempre vai ser menor que total(total vale 10), vai ficar em loop até 'mais' receber zero., cont vai ficar maior.
